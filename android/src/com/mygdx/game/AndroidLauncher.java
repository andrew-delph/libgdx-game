...
public class AndroidLauncher extends AndroidApplication {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //		Channel channel = ManagedChannelBuilder.forAddress("4.tcp.ngrok.io",
    // 15442).usePlaintext().build();
    //		NetworkObjectServiceGrpc.NetworkObjectServiceStub asyncStub =
    // NetworkObjectServiceGrpc.newStub(channel);
    //		StreamObserver<NetworkObjects.NetworkEvent> sender = asyncStub.networkObjectStream(new
    // StreamObserver<NetworkObjects.NetworkEvent>(){
    //			@Override
...
class PhysicsTest extends ApplicationAdapter implements InputProcessor {
