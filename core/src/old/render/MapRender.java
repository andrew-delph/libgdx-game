...
import old.base.BaseApplicationAdapter;
...
public class MapRender extends BaseApplicationAdapter {
  ...
  @Inject RenderManager renderManager;

  @Inject WorldMap worldMap;

  @Inject MapBuilder mapBuilder;
