...
public class SubscriptionIncomingConsumerServer implements Consumer<EventType> {
    ...
    public void accept(EventType eventType) {
        ...
        List<ChunkRange> userChunkRangeList =
                chunkSubscriptionManager.getUserChunkRangeSubscriptions(realEvent.getUser());
        ...
        chunkSubscriptionManager.registerSubscription(realEvent.getUser(), realEvent.getChunkRangeList());
